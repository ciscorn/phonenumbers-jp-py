import jp_phone_numbers


def test_parse_kotei():
    info = jp_phone_numbers.parse("0344445555")
    assert info.type == "固定"
...
def test_parse_mobile():
    info = jp_phone_numbers.parse("09011112222")
    assert info.type == "携帯"
...
def test_parse_m2m():
    info = jp_phone_numbers.parse("02011122222")
...
def test_parse_184_186():
    info = jp_phone_numbers.parse("1840355556666")
    assert info.area_code == "03"
    assert info.callerid_delivery == "withhold"
    assert info.parts == ["184", "03", "5555", "6666"]

    info = jp_phone_numbers.parse("1860355556666")
    assert info.area_code == "03"
...
def test_parse_carrier_selector():
    info = jp_phone_numbers.parse("00330355556666")
    assert info.area_code == "03"
    assert info.callerid_delivery is None
...
def test_parse_184_and_carrier():
    info = jp_phone_numbers.parse("18400330355556666")
    assert info.area_code == "03"
    assert info.callerid_delivery == "withhold"
...
def test_parse_international():
    info = jp_phone_numbers.parse("01081355554444")
