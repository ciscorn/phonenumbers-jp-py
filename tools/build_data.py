...
source.extend(
    [
        {"b": "050", "b1": "050", "m": 4, "type": "IP"},
        {"b": "0600", "b1": "0600", "m": 3, "type": "FMC"},
        {"b": "0120", "b1": "0120", "m": 3, "type": "フリーダイヤル"},
        {"b": "0800", "b1": "0800", "m": 3, "type": "フリーダイヤル"},
        {"b": "0204", "b1": "0204", "m": 3, "type": "ポケベル"},
        {"b": "0990", "b1": "0990", "m": 3, "type": "災害募金サービス"},
        {"b": "0570", "b1": "0570", "m": 3, "type": "ナビダイヤル"},
...
add_tokuban("164", "サービス条件設定【端末切り替え】")
...
add_tokuban("181", "サービス条件設定【ローミング】")
...
with open("jp_phone_numbers/_data.py", "w", encoding="utf-8") as f:
    f.write(body)
